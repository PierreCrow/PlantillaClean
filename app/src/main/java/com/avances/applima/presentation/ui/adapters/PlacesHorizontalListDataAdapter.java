...
public class PlacesHorizontalListDataAdapter extends RecyclerView.Adapter<PlacesHorizontalListDataAdapter.SingleItemRowHolder> {
    ...
    public PlacesHorizontalListDataAdapter(Context context, ArrayList<Place> itemsList) {
    ...
    public SingleItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.place_item_home, null);
